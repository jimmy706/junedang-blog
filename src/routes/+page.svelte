...
<Container>
  <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
    <div class="p-4 bg-gray-50 shadow-sm rounded-sm relative">
      ...
      <div
        class="flex justify-center mt-10 socials text-black px-2 py-4 gap-x-1"
      >
        <a
      ...
      <div class="mt-5">
        <h2 class="text-3xl font-bold text-black">About me</h2>
    ...
    <div class="p-4 bg-gray-50 shadow-sm rounded-sm relative col-span-2">
      <div class="flex justify-between items-end">
        ...
        <a
          href="/posts"
          class="text-sm font-semibold leading-6 text-gray-900 dark:text-gray-600 md:inline hidden"
